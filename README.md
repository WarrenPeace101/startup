...
Adding a Database was an interesting process. Being able to take your scores that you make during gameplay and ship them off to an external source. That's pretty cool. I liked seeing the interaction between the HTTP service, the Javascript code, and the database to which the scores were sent. It all makes a little more sense now. Now I'm excited that I'm able to boast my Simon skills against my siblings ;)
